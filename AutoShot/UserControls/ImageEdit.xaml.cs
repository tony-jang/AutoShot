    ...
    public partial class ImageEdit : System.Windows.Controls.UserControl
    {
        ...
        private void Tick_MoveChange(object sender, EventArgs e)
        {
            if (f.Control.MouseButtons == f.MouseButtons.Left)
            {
                ...
                ChangeThickness.Left = GetMargin(DragGrid.Margin, ThickPosition.Left, StartMargin.Left + MovedX, CropGrid.Width - DragGrid.Width, false).Left;
                ChangeThickness.Right = GetMargin(DragGrid.Margin, ThickPosition.Right, StartMargin.Right - MovedX, CropGrid.Width - DragGrid.Width, false).Right;
                ChangeThickness.Top = GetMargin(DragGrid.Margin, ThickPosition.Top, StartMargin.Top + MovedY, CropGrid.Height - DragGrid.Height, false).Top;
                ChangeThickness.Bottom = GetMargin(DragGrid.Margin, ThickPosition.Bottom, StartMargin.Bottom - MovedY, CropGrid.Height - DragGrid.Height, false).Bottom;
        ...
        private void Tick_CropChange(object sender, EventArgs e)
        {
            if (f.Control.MouseButtons == f.MouseButtons.Left)
            {
                ...
                {
                    DragGrid.Margin = GetMargin(DragGrid.Margin, ThickPosition.Bottom,
                ...
                {
                    DragGrid.Margin = GetMargin(DragGrid.Margin, ThickPosition.Top,
                        -AddedHeight + StartMargin.Top, CropGrid.ActualHeight - DragGrid.Margin.Bottom - 11);
                }

                if (IncMode.HasFlag(IncreaseMode.LeftIncrease))
                {
                    DragGrid.Margin = GetMargin(DragGrid.Margin, ThickPosition.Left,
                ...
                {
                    DragGrid.Margin = GetMargin(DragGrid.Margin, ThickPosition.Right,
